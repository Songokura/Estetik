...
window.SITE_EN = {
  ...
  "lp.vr.title":"Ingrown toenail in Aktobe - correction without removal | Marianna PRO",
  "lp.vr.desc":"Podiatrist Marianna, Aktobe: ingrown toenail correction with a brace, no nail removal. I relieve pain and inflammation on the first visit. 8 years of practice, working together with doctors. Visits from 15,000 KZT.",
  "lp.vr.k":"Aktobe · podiatrist · ingrown toenail",
  "lp.vr.t1":"Ingrown toenail -",
  "lp.vr.t2":"corrected, not removed",
  "lp.vr.lead":"I relieve pain and inflammation on the first visit and fit a corrective brace - the nail stays in place. 8 years of practice, 1000+ clients. Visits from 15,000 KZT, consultation by photo is free.",
  "lp.b2.primer":"Case study",
  "lp.gr.title":"Nail fungus in Aktobe - machine nail care by a podiatrist | Marianna PRO",
  "lp.gr.desc":"Podiatrist Marianna, Aktobe: machine care of fungus-affected nails together with a dermatologist. Sterile tools, home care advice. 8 years of practice. Visits from 15,000 KZT.",
  "lp.gr.k":"Aktobe · podiatrist · nail fungus",
  "lp.gr.t1":"Nail fungus -",
  "lp.gr.t2":"machine nail care",
  "lp.gr.lead":"I remove the affected layers of the nail so the treatment prescribed by a dermatologist can work. 8 years of practice, 1000+ clients. Visits from 15,000 KZT, consultation by photo is free.",
  "lp.st.title":"Orthopedic insoles in Aktobe - made for your feet | Marianna PRO",
  "lp.st.desc":"Podiatrist Marianna, Aktobe: podoscope foot diagnostics and custom orthopedic insoles together with orthopedists from Moscow. For flat feet and bunions. Visits from 15,000 KZT.",
  ...
  "lp.bo.k":"Aktobe · podiatrist · warts",
  "lp.bo.t1":"Warts -",
  "lp.bo.t2":"gentle removal",
  "lp.bo.lead":"Plantar warts, warts on toes and on hands. Step by step and gentle, together with a dermatologist if needed. Visits from 15,000 KZT, consultation by photo is free.",
  "lp.di.title":"Diabetic foot in Aktobe - podiatrist care | Marianna PRO",
  "lp.di.desc":"Podiatrist Marianna, Aktobe: foot checks and gentle care with diabetes, footwear and insoles with an orthopedist, referral to an endocrinologist or vascular surgeon. Visits from 15,000 KZT.",
  "lp.di.k":"Aktobe · podiatrist · diabetic foot",
  "lp.di.t1":"Diabetic foot -",
  "lp.di.t2":"gentle care",
  "lp.di.lead":"Foot checks, gentle nail and skin care, footwear and insoles with an orthopedist. If needed, I refer you to an endocrinologist or vascular surgeon. Visits from 15,000 KZT.",
  /* LP-END */
