...
var WA_RU = {
  hero:     "Здравствуйте! Пишу с сайта «Марианна PRO». Хочу записаться на приём. Проблема: ",
  vrosshiy: "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: коррекция вросшего ногтя.\nХочу записаться. Удобное время: ",
  stelki:   "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: ортопедические стельки.\nХочу записаться на диагностику. Удобное время: ",
  gribok:   "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: обработка ногтей при грибке.\nХочу записаться. Удобное время: ",
  diabet:   "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: уход за стопами при диабете.\nХочу записаться. Удобное время: ",
  pedikyur: "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: медицинский педикюр.\nХочу записаться. Удобное время: ",
  stopy:    "Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: обработка стоп (натоптыши, мозоли, трещины).\nХочу записаться. Удобное время: ",
  borodavki:"Здравствуйте! Пишу с сайта «Марианна PRO».\nУслуга: удаление бородавок.\nХочу записаться. Удобное время: ",
  online:   "Здравствуйте! Хочу бесплатную онлайн-консультацию по фото. Отправляю фото проблемы:",
  kontakty: "Здравствуйте! Пишу с сайта «Марианна PRO». Вопрос: "
};
...
function openVideo(card){
  ...
  modal.classList.toggle("wide", card.hasAttribute("data-wide"));
